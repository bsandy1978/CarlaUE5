...
def main():
    ...
    try:
        ...
        target_hex_code = "#00008e"  
        target_rgb = hex_to_rgb(target_hex_code)
        ...
        with CarlaSyncMode(world, camera_rgb, camera_semseg, camera_depth, fps=30) as sync_mode:
            while True:
                ...
                pil_image = Image.frombytes('RGBA', 
                            (image_semseg.width, image_semseg.height), 
                            image_semseg.raw_data)
                ...
                for x in range(width):
                    for y in range(height):
                     if image_semseg.getpixel((x, y)) == target_rgb:
                        matching_pixels += 1
